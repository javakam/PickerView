...
import ando.widget.wheelview.listener.LoopViewGestureListener;
import ando.widget.wheelview.listener.OnItemSelectedListener;
import ando.widget.wheelview.timer.InertiaTimerTask;
import ando.widget.wheelview.timer.MessageHandler;
import ando.widget.wheelview.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    private void initPaints() {
        ...
        paintCenterText.setTextScaleX(1.0F);//关闭默认数字文本缩放
    ...
    public final int getCurrentItemValueInt() {
        final Object value = getCurrentItemValue();
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (mGravity) {
            case Gravity.CENTER://显示内容居中
                if (isOptions || label == null || label.isEmpty() || !isCenterLabel) {
